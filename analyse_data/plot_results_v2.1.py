...
data_points = load_from_file(r"resaults_analisys_v2.2")
...
for part_soap in np.unique(data_points[:,key_part_soap]):
    ...
    idx_garbage = data_points[:,key_is_garbage]*False
    idx_garbage = data_points[:,key_distance_betwean_centers_of_circles] > 40
